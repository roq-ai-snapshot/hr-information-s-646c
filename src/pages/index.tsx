  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Information System - Your ultimate destination for managing employee data, vacations, and payroll seamlessly and efficiently."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Information System - Your ultimate destination for managing employee data, vacations, and payroll seamlessly and efficiently.`}
            </Text>
            <Box
